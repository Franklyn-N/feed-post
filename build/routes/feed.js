 ...
 *
 */
router.get("/feeds", feed_1.default.getPosts);
/**
 * @swagger
 *
 * /api/feed/{feedId}:
 ...
 *
 */
router.get("/feed/:feedId", feed_1.default.getPost);
/**
 * @swagger
 *
 * /api/feed:
 ...
 */
router.post("/feed", feed_1.default.createPost);
/**
 * @swagger
 *
 ...
 *
 */
router.delete("/deletefeed/:feedId", feed_1.default.deletePost);
